...
light_source { <-20.00, 60.00, -5.00> White}
//light_source { <20.00, -60.00, -5.00> color Gray50 }
...
texture {
   ...
   pigment { color red 1 green 0.25 blue 0.25 }
}
...
texture {
   ...
   pigment { color red 1 green 0.30 blue 0.25 }
}
