...
#declare Final = union {
    object { OuterShell scale <1,1,1> translate <0,3,0> }
    object { OuterShell scale <1-B*1,1-B*1,1-B*1> translate <0,3-B*5,0> }
    object { OuterShell scale <1-B*2,1-B*2,1-B*2> translate <0,3-B*10,0> }
    object { OuterShell scale <1-B*3,1-B*3,1-B*3> translate <0,3-B*15,0> }
    object { OuterShell scale <1-B*4,1-B*4,1-B*4> translate <0,3-B*20,0> }
//    object { OuterShell scale <1-B*5,1-B*5,1-B*5> translate <0,3-B*25,0> }
//    object { OuterShell scale <1-B*6,1-B*6,1-B*6> translate <0,3-B*30,0> }
//    object { OuterShell scale <1-B*7,1-B*7,1-B*7> translate <0,3-B*35,0> }
//    object { OuterShell scale <1-B*8,1-B*8,1-B*8> translate <0,3-B*40,0> }
//  Barrel
//  object { GlassSphere }
//  object { GlowEye }
}
